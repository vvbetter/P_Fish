...
class ReqJoinRoomMessage : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_isarena() const;
  inline void clear_isarena();
  static const int kIsArenaFieldNumber = 3;
  inline ::google::protobuf::int32 isarena() const;
  inline void set_isarena(::google::protobuf::int32 value);
 ...
 private:
  ...
  inline void set_has_isarena();
  inline void clear_has_isarena();
  
  ::google::protobuf::UnknownFieldSet _unknown_fields_;
  
  int msgid_;
  ::google::protobuf::int32 roomid_;
  ::google::protobuf::int32 isarena_;
...
// optional int32 isArena = 3;
inline bool ReqJoinRoomMessage::has_isarena() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void ReqJoinRoomMessage::set_has_isarena() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ReqJoinRoomMessage::clear_has_isarena() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void ReqJoinRoomMessage::clear_isarena() {
  isarena_ = 0;
  clear_has_isarena();
}
inline ::google::protobuf::int32 ReqJoinRoomMessage::isarena() const {
  return isarena_;
}
inline void ReqJoinRoomMessage::set_isarena(::google::protobuf::int32 value) {
  set_has_isarena();
  isarena_ = value;
}

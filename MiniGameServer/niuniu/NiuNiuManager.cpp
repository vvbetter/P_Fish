...
{
	if (m_NiuNiuUpdateTime == 0 || dwTimer - m_NiuNiuUpdateTime >= 1000) //1s更新一次
	{
...
void NiuNiuManager::OnTableJoinEnd()
{
	...
	{
		//当前为玩家自行创建的 我们需要对结果进行修改 设置倍率为1 并且 庄家一定胜利
		RestAllBrandInfo();//交换牌 庄家最大
	...
	//系统金币递减 必须 房间里有真实玩家 并且 真实玩家真实下注了

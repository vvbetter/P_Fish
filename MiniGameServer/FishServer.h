...
public:
	...
	NiuNiuControl&	GetNiuNiuControl(){ return m_NiuNiuControl; }
	...
	IRoomManager* GetRoomManager(){ return m_pRoomManager; }
private:
	bool ConnectClient();
	bool ConnectDB();
	bool ConnectLogDB();
